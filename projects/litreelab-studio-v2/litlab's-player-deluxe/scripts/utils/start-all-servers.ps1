...
$DashboardPath = Join-Path $ModulesRoot 'dashboard'
$GridPath = Join-Path $ModulesRoot 'grid'
$SocialPath = Join-Path $ModulesRoot 'social'

$DashboardPython = if (Test-Path (Join-Path $DashboardPath '.venv\Scripts\python.exe')) {
    Join-Path $DashboardPath '.venv\Scripts\python.exe'
}
else {
    'python'
}

$GridPython = if (Test-Path (Join-Path $GridPath '.venv\Scripts\python.exe')) {
    Join-Path $GridPath '.venv\Scripts\python.exe'
}
else {
    'python'
}
