...
export function ChatBotOnboarding() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // Call Cloud Function
      const response = await callGenerateOnboardingResponse(
        step,
        userText,
        updatedProfile,
      );
    ...
    return (
      <div className="rounded-lg border border-[#40e0d0]/30 bg-gradient-to-br from-[#0a0a0a] to-[#1a1a1a] p-6 shadow-lg">
        <h3 className="mb-4 text-lg font-bold text-white">
          🤖 Welcome to LitLabs OS
        </h3>
        <p className="mb-4 text-sm text-gray-400">
          Let&apos;s set you up. Just answer a few questions so I can understand
          your business and help you make money faster.
        </p>
        <button
        ...
        <div className="space-y-4 rounded-lg border border-[#40e0d0]/50 bg-[#0a0a0a] p-4 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              I&apos;ve got your profile saved. Now you&apos;re ready to use all
              the features:
            </p>
