...
export async function createBot(
  ...
  const defaultConfig: BotConfig = {
    ...
    customization: {
      welcomeMessage:
        config.customization?.welcomeMessage ||
        "Hello! How can I help you today?",
      fallbackMessage:
        config.customization?.fallbackMessage ||
        "I didn't understand that. Could you rephrase?",
      errorMessage:
        config.customization?.errorMessage ||
 ...
 */
export function validateBotCode(code: string): {
  valid: boolean;
  errors: string[];
} {
  const errors: string[] = [];
  ...
  if (code.includes("eval(") || code.includes("Function(")) {
    errors.push(
      "Dangerous code detected: eval() and Function() are not allowed",
    );
  }
  ...
  return [
    {
      ...
      systemPrompt:
        "You are a helpful customer support agent. Be friendly, professional, and solve problems efficiently.",
    ...
    },
    {
      ...
      category: "sales",
      systemPrompt:
        "You are a sales assistant. Qualify leads, answer product questions, and schedule demos.",
    ...
    },
    {
      ...
      category: "content",
      systemPrompt:
        "You are a creative content writer. Generate engaging blog posts, social media captions, and marketing copy.",
    ...
    },
    {
      ...
      systemPrompt:
        "You are an appointment scheduling assistant. Help users book, reschedule, and manage appointments.",
    ...
    },
    {
      ...
      category: "fun",
      systemPrompt:
        "You are a fun trivia game host. Ask questions, keep score, and make learning entertaining.",
