...
async function runtimeConsume(ip) {
  if (initialized && redisLimiter) {
    try {
      ...
      return {
        ok: true,
        remaining:
          typeof (res === null || res === void 0
            ? void 0
            : res.remainingPoints) === "number"
            ? res.remainingPoints
            : undefined,
      };
    } catch (rej) {
      const sec =
        Math.ceil(
          ((rej === null || rej === void 0 ? void 0 : rej.msBeforeNext) ||
            1000) / 1000,
        ) || 1;
      return {
        ok: false,
        retryAfter: sec,
        remaining:
          typeof (rej === null || rej === void 0
            ? void 0
            : rej.remainingPoints) === "number"
            ? rej.remainingPoints
            : undefined,
      };
    }
  ...
  try {
    ...
    try {
      RateLimiterFlexibleMod = await new Function("n", "return import(n)")(
        rateLimiterFlexibleName,
      );
    } catch {
    ...
    if (process.env.REDIS_URL && IORedisMod && RateLimiterFlexibleMod) {
      ...
      const RateLimiterFlexible =
        RateLimiterFlexibleMod.default || RateLimiterFlexibleMod;
      const RateLimiterRedis =
        RateLimiterFlexible === null || RateLimiterFlexible === void 0
          ? void 0
          : RateLimiterFlexible.RateLimiterRedis;
    ...
    if (
      e &&
      typeof (e === null || e === void 0 ? void 0 : e.msBeforeNext) === "number"
    ) {
      const sec =
        Math.ceil(
          ((e === null || e === void 0 ? void 0 : e.msBeforeNext) || 1000) /
            1000,
        ) || 1;
      return {
        ok: false,
        retryAfter: sec,
        remaining:
          typeof (e === null || e === void 0 ? void 0 : e.remainingPoints) ===
          "number"
            ? e.remainingPoints
            : undefined,
      };
