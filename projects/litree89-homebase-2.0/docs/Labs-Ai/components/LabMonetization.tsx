...
const streams = [
  {
    name: "Subscriptions",
    items: ["$5→$200 tiers", "Yearly toggle", "Auto-downgrade on fail"],
  },
  {
    name: "Marketplace",
    items: ["Sell themes/widgets", "Commission on sales", "NFT drops"],
  },
  {
    name: "Add-ons",
    items: ["Storage boosts", "Streaming boost", "Premium AI commands"],
  },
  {
    name: "Sponsored",
    items: [
      "Widgets: crypto, news, fitness",
      "Branded themes",
      "Event takeovers",
    ],
  },
  {
    name: "Affiliate",
    items: ["Gaming store links", "Hardware partners", "Overlay packs"],
  },
  {
    name: "VIP Events",
    items: ["Paid tournaments", "Listening parties", "Creator collabs"],
  },
];
    ...
    <section className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-[0_0_30px_rgba(16,185,129,0.12)]">
      <div className="flex items-center justify-between">
        <h3 className="text-xl font-semibold text-white">
          Monetization grid (cash grab mode)
        </h3>
