      ...
      <div className="relative grid gap-8 lg:grid-cols-[1.2fr_1fr] items-center">
        <div className="space-y-5">
          ...
          <h1 className="text-4xl sm:text-5xl font-semibold leading-tight text-white">
            Your holographic command center for games, music, media, AI, and
            cashflow.
          </h1>
          <p className="text-slate-300 max-w-3xl">
            Drag-and-drop everything. Launch cloud gaming, stream with neon
            overlays, sell themes, run AI assistants, and get paid—across web,
            iOS, and Android. Security stays admin-only, users just see the
            glow.
          </p>
          ...
          <div className="grid gap-4 sm:grid-cols-3 text-sm text-slate-200">
            {[
              [
                "Any login",
                "Apple · Steam · Xbox · PlayStation · Google · Discord · Twitch",
              ],
              [
                "Any payment",
                "Cards · Apple/Google Pay · PayPal · Crypto (BTC/ETH)",
              ],
              [
                "Security",
                "Admin-only panel · MFA · IP allowlist · WAF · audits",
              ],
            ].map(([title, desc]) => (
              <div
                key={title}
          ...
          <div className="relative overflow-hidden rounded-2xl border border-emerald-400/30 bg-black/60 p-4 shadow-[0_0_60px_rgba(16,185,129,0.25)] backdrop-blur">
            ...
            <div className="mt-3 space-y-3 text-sm text-slate-200">
              ...
              <div className="rounded-xl border border-emerald-400/40 bg-emerald-500/10 px-3 py-2 text-emerald-100">
                ...
                <p className="mt-1">
                  Subs · marketplace commissions · add-ons · sponsored widgets ·
                  NFTs.
                </p>
              </div>
            </div>
