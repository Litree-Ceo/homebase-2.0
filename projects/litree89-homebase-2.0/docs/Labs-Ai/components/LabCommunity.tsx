...
export function LabCommunity() {
  const items = [
    {
      title: "Leaderboards",
      detail: "Top creators, layouts, retro runs, streaming overlays.",
    },
    {
      title: "Events",
      detail: "Tournaments, music parties, limited drops, sponsor activations.",
    },
    {
      title: "Chat hub",
      detail: "Channels for games, music, building; mod tools.",
    },
    {
      title: "Gamification",
      detail: "Badges for customization, streaks, and event wins.",
    },
  ];
