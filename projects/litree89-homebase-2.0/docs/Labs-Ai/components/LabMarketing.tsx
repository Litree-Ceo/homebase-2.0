  ...
  const channels = [
    {
      ...
      detail:
        "TikTok/IG Reels hero motion clips; Twitch/YouTube partners; Discord hub.",
    },
    {
      title: "Campaigns",
      detail:
        "Waitlist + invite codes; design-to-earn contest; NFT/skin drops; VIP events.",
    },
    {
      title: "Ads + Retarget",
      detail:
        "Short vertical ads showing drag/drop + AI orb + payment glow; retarget to Ultimate.",
    },
    {
      title: "SEO + Content",
      detail:
        "Pages for custom gaming dashboard, AI streaming overlay, emulation hub; schema + FAQs.",
    },
  ];
  ...
  return (
    <section className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-[0_0_30px_rgba(16,185,129,0.12)]">
      ...
      <div className="mt-4 rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-100">
        Add live mini-dashboard on landing; CTA to join Discord; showcase top
        layouts + testimonials for social proof.
      </div>
    </section>
  );
}
