...
export function LabAppPreview() {
  const widgets = [
    {
      title: "Game Hub",
      detail: "Steam · Xbox · PS · Cloud gaming",
      accent: "bg-emerald-400/30",
    },
    {
      title: "Music Universe",
      detail: "Spotify · Apple · Visualizer",
      accent: "bg-cyan-400/30",
    },
    {
      title: "Photos AI",
      detail: "AI tagging · Slideshow + music",
      accent: "bg-blue-400/30",
    },
    {
      title: "Marketplace",
      detail: "Themes · Widgets · NFT drops",
      accent: "bg-purple-400/30",
    },
    {
      title: "AI Assistant",
      detail: "Voice + chat quick actions",
      accent: "bg-pink-400/30",
    },
    {
      title: "Security",
      detail: "Admin-only · WAF · MFA · audits",
    ...
    >
      <div className="flex items-center justify-between">
        <h3 className="text-xl font-semibold text-white">
          Live mini-dashboard preview (teaser)
        </h3>
