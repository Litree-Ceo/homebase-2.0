  ...
  const cards = [
    {
      ...
      desc: "Sell/buy animated dashboards, overlays, widgets. Commission on every sale.",
    },
    {
      title: "NFT Holographic Drops",
      desc: "Limited skins with proof-of-ownership; unlocks VIP visuals and badges.",
    },
    {
      title: "Creator Tools",
      desc: "Package layouts, set pricing, offer bundles; auto-handle payouts.",
    },
    {
      title: "Sponsored Slots",
      desc: "Featured placements for brands or partner widgets (crypto, news, fitness).",
    },
  ];
    ...
    <section className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-[0_0_30px_rgba(16,185,129,0.12)]">
      <div className="flex items-center justify-between">
        <h3 className="text-xl font-semibold text-white">
          Marketplace (themes · widgets · NFTs)
        </h3>
      ...
      <div className="mt-4 rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-100">
        Commission model: marketplace % + upsells (featured placement, sponsor
        skins). AI assistant can suggest pricing.
      </div>
    </section>
  );
}
