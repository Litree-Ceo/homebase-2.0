...
export default function GodModePanel() {
  const [mode, setMode] = useState<"execute" | "video" | "competitor">(
    "execute",
  );
  ...
  const [platform, setPlatform] = useState<"tiktok" | "youtube" | "instagram">(
    "tiktok",
  );
  const [style, setStyle] = useState<
    "educational" | "entertaining" | "salesy" | "storytelling"
  >("entertaining");
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 p-8 text-white">
        <div className="relative z-10">
          ...
          <p className="text-purple-100 max-w-2xl">
            Ultra-intelligent AI that researches, strategizes, and executes like
            a $500/hour expert. Pulls from multiple sources to deliver perfect
            results every time.
          </p>
        </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        >
          <Sparkles
            className={`w-6 h-6 mb-2 ${mode === "execute" ? "text-purple-600" : "text-gray-400"}`}
          />
          <h3 className="font-semibold">Smart Execute</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Research & create anything
          </p>
        </button>
        ...
        >
          <Video
            className={`w-6 h-6 mb-2 ${mode === "video" ? "text-pink-600" : "text-gray-400"}`}
          />
        ...
        >
          <Target
            className={`w-6 h-6 mb-2 ${mode === "competitor" ? "text-red-600" : "text-gray-400"}`}
          />
          <h3 className="font-semibold">Competitor Intel</h3>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Spy on top performers
          </p>
        </button>
      </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-6">
          ...
          <div className="space-y-4">
            ...
            <label className="flex items-center gap-2">
              ...
              <span className="text-sm">
                Include research & competitor analysis (takes longer but better
                results)
              </span>
            </label>
          </div>
        ...
        <button
          ...
          disabled={
            loading ||
            (mode === "execute" && !task) ||
            (mode === "video" && !videoTopic) ||
            (mode === "competitor" && !businessType)
          }
