...
const phases = [
  {
    title: "Phase 1 · Core",
    items: [
      "Backend (auth, RBAC, Stripe/Coinbase)",
      "DB schema for users/subs/marketplace/audits",
      "OAuth (Apple/Steam/Google/etc.)",
    ],
  },
  {
    title: "Phase 2 · Security",
    items: [
      "MFA, IP allowlist, WAF/ratelimits",
      "Audit log ingestion + alerts",
      "Admin-only panel surface",
    ],
  },
  {
    title: "Phase 3 · Dashboard",
    items: [
      "Drag/drop widgets, theme builder",
      "Live mini-preview, immersive mode",
      "AI assistant core + quick actions",
    ],
  },
  {
    title: "Phase 4 · Advanced",
    items: [
      "Marketplace (themes/widgets)",
      "AI premium features",
      "Cloud sync + offline basics",
    ],
  },
  {
