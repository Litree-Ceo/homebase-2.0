      ...
      return NextResponse.json(
        {
          ...
          details:
            "GOOGLE_GENERATIVE_AI_API_KEY not found in environment variables. Check your .env.local file.",
        },
        { status: 500 },
      );
    }
      ...
      return NextResponse.json(
        {
          ...
          details:
            "You need to replace the placeholder with your actual Google AI API key. See SETUP_MISSING_TOOLS.md for instructions.",
        },
        { status: 500 },
      );
    }
