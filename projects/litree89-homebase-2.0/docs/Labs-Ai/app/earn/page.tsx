      ...
      <div className="space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-slate-300">
            Multiple ways to monetize your creativity
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="rounded-xl border border-emerald-500/50 bg-slate-900/60 p-6">
            ...
            <p className="text-slate-300 mb-4">
              Earn <span className="text-emerald-400 font-bold">$5</span> for
              every free signup and{" "}
              <span className="text-emerald-400 font-bold">20%</span> recurring
              commission on paid plans
            </p>
          ...
          <div className="rounded-xl border border-purple-500/50 bg-slate-900/60 p-6">
            ...
            <p className="text-slate-300 mb-4">
              ...
              <span className="text-purple-400 font-bold">70%</span> of every
              sale
            </p>
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm">
          ...
          <div className="rounded-xl border border-cyan-500/50 bg-slate-900/60 p-6">
            ...
            <p className="text-slate-300 mb-4">
              ...
              <span className="text-cyan-400 font-bold">20%</span> on every sale
              through your link
            </p>
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-sm">
