...
export default function AIActionsPage() {
  ...
  const [activeTab, setActiveTab] = useState<
    "generator" | "dm" | "money" | "images" | "godmode"
  >("generator");
  ...
  const handleSaveContent = async (
    content: string,
    type: "caption" | "script" | "dm" | "moneyPlay",
  ) => {
    if (!user?.uid) return;
    try {
      await saveToLibrary(user.uid, type, content, {
        platform:
          formData.contentType === "instagram_caption" ? "instagram" : "tiktok",
  ...
  useEffect(() => {
    if (user?.uid) {
      getUsageStats(user.uid).then((stats) => {
        ...
        const tier = (stats.tier === "starter" ? "free" : stats.tier) as
          | "free"
          | "pro"
          | "enterprise";
        setUsageStats({
      ...
      if (response.status === 403 && data.upgradeRequired) {
        ...
        if (user?.uid) {
          getUsageStats(user.uid).then((stats) => {
            const normalized = {
              ...stats,
              tier: (stats.tier === "starter" ? "free" : stats.tier) as
                | "free"
                | "pro"
                | "enterprise",
            };
            ...
            <div className="flex gap-4 mt-6">
              <div className="bg-white/5 border border-white/10 rounded-lg px-4 py-2">
                ...
                <p className="text-xl font-bold text-white">
                  {usageStats ? (
                    <>
                      {usageStats.today.aiGenerations +
                        usageStats.today.dmReplies +
                        usageStats.today.moneyPlays}
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    >
                      <option value="instagram_caption">
                        📸 Instagram Caption
                      </option>
            ...
            <div className="space-y-6 p-6 bg-white/5 border border-white/10 rounded-xl">
              <div>
                ...
                <p className="text-sm text-gray-400 mb-4">
                  Powered by DALL-E 3 • Create stunning visuals for your posts
                </p>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-2">
                      💡 Tip: Be specific about style, colors, mood, and
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <button
                      onClick={() =>
                        user?.uid &&
                        saveToLibrary(user.uid, "image", imagePrompt, {
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    />
                    <p className="text-xs text-gray-500 mt-2">
                      💡 Paste the exact message from Instagram, TikTok, or text
                    </p>
                  </div>
                  ...
                  >
                    {loading ? (
                      <span className="flex items-center justify-center gap-2">
                        <span className="animate-spin">⚡</span> Crafting
                        Reply...
                      </span>
                    ) : (
                      <span className="flex items-center justify-center gap-2">
            ...
            <div className="p-6 bg-gradient-to-br from-white/5 to-white/10 border border-white/20 rounded-xl shadow-2xl">
              ...
              {dmReply ? (
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <button className="flex-1 px-4 py-2 rounded-lg bg-green-500/10 border border-green-500/30 text-green-400 text-sm font-bold hover:bg-green-500/20 transition">
                      ✅ Perfect!
                    </button>
                    <Link
                      href="/dashboard/library"
                ...
                <div className="min-h-[300px] flex flex-col items-center justify-center text-center">
                  ...
                  <p className="text-gray-600 text-xs mt-2">
                    Paste a customer message and generate!
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="p-8 bg-gradient-to-br from-green-500/20 via-emerald-500/10 to-green-600/20 border border-green-500/30 rounded-xl text-center">
              ...
              <h3 className="text-2xl font-black text-white mb-2">
                Daily Money Play Generator
              </h3>
              <p className="text-gray-400 mb-6">
                AI-powered revenue boosting offers tailored to your business
              </p>
              ...
              >
                {loading ? (
                  <span className="flex items-center justify-center gap-2">
                    <span className="animate-spin">⚡</span> Generating Money
                    Play...
                  </span>
                ) : (
                  <span className="flex items-center justify-center gap-2">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 p-8 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border-2 border-green-500/50 rounded-xl text-center">
                  ...
                  <p className="text-6xl font-black text-green-400 mb-2">
                    +{moneyPlay.estimatedLift}%
                  </p>
                  <p className="text-gray-400 text-sm">
                    Based on similar offers in your industry
                  </p>
          ...
          <div className="bg-gray-900 border border-pink-500/50 rounded-2xl p-8 max-w-md w-full shadow-2xl">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-400">
                You've used all your free generations for today. Upgrade to Pro
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-pink-400 font-bold">
                      {usageStats.today.aiGenerations} /{" "}
                      {usageStats.limits.aiGenerations}
                    </span>
                  </div>
                  <div className="flex justify-between items-center">
