  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        ...
        {/* Steps */}
        {step === 1 && (
          <StepBasics formData={formData} onChange={handleInputChange} />
        )}
        {step === 2 && (
          <StepClients formData={formData} onChange={handleInputChange} />
        )}
        {step === 3 && (
          <StepSchedule formData={formData} onChange={handleInputChange} />
        )}
...
function Input({
  ...
  return (
    <div className="space-y-1">
      ...
      />
      {helper && <p className="text-[10px] text-white/45">{helper}</p>}
    </div>
  );
}
...
function StepBasics({
  ...
  onChange: (field: keyof OnboardingForm, val: string) => void;
}) {
  return (
    <section className="grid gap-4 lg:grid-cols-2">
      ...
      <Card>
        <p className="text-xs font-semibold text-white/75 mb-2">Your vibe</p>
        <TextArea
    ...
    <section className="grid gap-4 lg:grid-cols-2">
      ...
      <Card>
        ...
        <p className="text-[10px] text-emerald-300 pt-1">
          The more real you are here, the smarter your scripts and promos will
          feel.
        </p>
      </Card>
    </section>
