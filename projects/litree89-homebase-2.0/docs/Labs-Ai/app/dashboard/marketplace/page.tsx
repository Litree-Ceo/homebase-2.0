...
export default function MarketplacePage() {
  ...
  const handlePurchase = async (templateId: string) => {
    ...
    const confirmed = confirm(
      "Purchase this template? You'll be charged via your Stripe account.",
    );
    if (!confirmed) return;
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 rounded-2xl p-8 text-white">
          ...
          <p className="text-blue-100 text-lg max-w-3xl">
            Buy proven templates from top creators. Sell your best content for
            passive income.
            <span className="font-bold ml-2">
              30% commission • Instant delivery
            </span>
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-green-600 to-emerald-600 rounded-2xl p-8 text-white text-center">
          ...
          <p className="text-green-100 mb-6 max-w-2xl mx-auto">
            Turn your best templates into passive income. Earn 70% on every
            sale. Top sellers make $500-2000/month on autopilot.
          </p>
