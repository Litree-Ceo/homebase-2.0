...
export default function AnalyticsPage() {
  ...
  return (
    <DashboardLayout>
      <div className={styles.dashboardAnalyticsContainer + " max-w-7xl mx-auto space-y-6"}>
        {/* Header */}
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-purple-100 text-lg max-w-2xl">
                AI-powered insights to predict viral content, optimize posting
                times, and dominate your niche
              </p>
            </div>
                  ...
                  <div className="flex-1">
                    <h3 className="text-xl font-bold mb-2 flex items-center gap-2">
                      ...
                      <span className="text-sm bg-yellow-400 text-yellow-900 px-3 py-1 rounded-full">
                        {analytics.bestPerformingPost.engagementRate.toFixed(2)}
                        % engagement
                      </span>
                    </h3>
                    ...
                    <div className="flex gap-6 text-sm">
                      <span className="flex items-center gap-1">
                        ...
                        {analytics.bestPerformingPost.views.toLocaleString()}{" "}
                        views
                      </span>
                      <span className="flex items-center gap-1">
                        <Heart className="w-4 h-4" />
                        {analytics.bestPerformingPost.likes.toLocaleString()}{" "}
                        likes
                      </span>
                      <span className="flex items-center gap-1">
                      ...
                      <span className="text-gray-500">
                        {analytics.bestPerformingPost.platform} •{" "}
                        {analytics.bestPerformingPost.postedAt.toLocaleDateString()}
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  {analytics.recommendations.map((rec, i) => (
                    <div
                      key={i}
                      className="flex gap-3 p-3 bg-yellow-50 dark:bg-yellow-950 rounded-lg"
                    >
              ...
              <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-6">
                ...
                <div className="space-y-3">
                  {analytics.competitorInsights.map((insight, i) => (
                    <div
                      key={i}
                      className="flex gap-3 p-3 bg-red-50 dark:bg-red-950 rounded-lg"
                    >
                    ...
                    >
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <ul className="space-y-1">
                            {pred.suggestedImprovements.map(
                              (improvement, j) => (
                                <li
                                  key={j}
                                  className="text-sm flex items-start gap-2"
