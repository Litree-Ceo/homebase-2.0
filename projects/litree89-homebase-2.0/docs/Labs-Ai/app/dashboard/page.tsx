...
const ChatBotOnboarding = dynamic(
  () =>
    import("@/components/dashboard/ChatBot").then((mod) => ({
      default: mod.ChatBotOnboarding,
    })),
  { ssr: false },
);
      ...
      <div className="space-y-8">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-pink-500/20 via-purple-500/10 to-sky-500/20 p-12 shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-lg text-white/80 max-w-2xl">
              Your AI is ready to work. Generate content, reply to DMs, and grow
          ...
          <div className="group relative overflow-hidden rounded-xl border border-white/10 bg-gradient-to-br from-slate-800 to-slate-900 p-6 hover:border-purple-500/50 transition">
            <div className="relative z-10">
              ...
              <p className="text-xs text-white/50 mt-2">
                {stats.tier === "free" ? "Upgrade?" : "Premium!"}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div
            ...
            className="group relative rounded-xl border border-white/10 bg-gradient-to-br from-slate-800 to-slate-900 overflow-hidden hover:border-pink-500/50 transition p-8 cursor-pointer"
          >
            <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-pink-500 to-purple-500 flex items-center justify-center text-xl mb-4">
              🧠
            </div>
            <h3 className="text-xl font-bold text-white mb-2">GOD MODE AI</h3>
            <p className="text-white/70 mb-6">
              Ultra-intelligent content creation & research
            </p>
          ...
          <div
            ...
            className="group relative rounded-xl border border-white/10 bg-gradient-to-br from-slate-800 to-slate-900 overflow-hidden hover:border-blue-500/50 transition p-8 cursor-pointer"
          >
            <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center text-xl mb-4">
              🛍️
            </div>
            ...
            <p className="text-white/70 mb-6">
              Buy & sell proven templates, earn passive income
            </p>
            <button className="px-4 py-2 rounded-lg bg-blue-500/20 hover:bg-blue-500/30 text-blue-300 text-sm font-semibold transition">
              Browse →
            </button>
          </div>
          ...
          <div
            ...
            className="group relative rounded-xl border border-white/10 bg-gradient-to-br from-slate-800 to-slate-900 overflow-hidden hover:border-purple-500/50 transition p-8 cursor-pointer"
          >
            <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-xl mb-4">
              📊
            </div>
            <h3 className="text-xl font-bold text-white mb-2">
              Analytics Dashboard
            ...
            <p className="text-white/70 mb-6">
              Predict viral content with AI-powered insights
            </p>
          ...
          <div
            onClick={() => router.push("/dashboard/ai")}
            className="group relative rounded-xl border border-white/10 bg-gradient-to-br from-slate-800 to-slate-900 overflow-hidden hover:border-emerald-500/50 transition p-8 cursor-pointer"
          >
            <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center text-xl mb-4">
              🎬
            </div>
            <h3 className="text-xl font-bold text-white mb-2">
            ...
            <p className="text-white/70 mb-6">
              Scene-by-scene viral scripts for TikTok & IG
            </p>
            <button className="px-4 py-2 rounded-lg bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 text-sm font-semibold transition">
              Create Script →
            </button>
          </div>
        </div>
          ...
          <div className="relative rounded-2xl border border-white/10 bg-gradient-to-r from-pink-500/10 via-purple-500/10 to-sky-500/10 p-8 text-center">
            <div className="relative z-10">
              ...
              <p className="text-white/70 mb-6 max-w-2xl mx-auto">
                Upgrade to Pro for unlimited posts, advanced analytics, and
                priority support.
              </p>
              <button className="px-8 py-3 rounded-lg bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white font-semibold shadow-lg shadow-pink-500/30 transition">
                Upgrade Now
              </button>
            </div>
          </div>
