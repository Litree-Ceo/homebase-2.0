...
export default function GeminiResultsPage() {
  ...
  return (
    <main className="relative text-foreground bg-surface w-full">
      <BackButton
        href={GEMINI.HOME}
        className="text-white bg-white/10 border-white/20 backdrop-blur-xl"
      />
      ...
      <section className="container relative flex flex-col items-center gap-6 w-full transition-opacity duration-300 ease-in-out py-5">
        <header className="text-white w-full text-center text-lg h-16 flex justify-center items-center font-bold tracking-wide">
          Dream Trips
        </header>
