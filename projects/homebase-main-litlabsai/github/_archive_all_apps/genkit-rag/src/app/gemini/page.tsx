...
export default function GeminiPromptPage() {
  ...
  return (
    <main className="container relative flex flex-col gap-6 bg-surface text-foreground min-h-screen">
      <form action={formAction} className="w-full max-w-2xl mx-auto flex flex-col h-full flex-grow">
        {/* 
