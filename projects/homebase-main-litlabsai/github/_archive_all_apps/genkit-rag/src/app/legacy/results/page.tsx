...
export default function LegacyResultsPage({
  ...
  return (
    <main className="container relative flex flex-col gap-6 bg-background py-5 min-h-screen">
      <HomeButton className="border-white/20 backdrop-blur-xl text-white bg-white/10" />

      <section className="px-5 mr-[50px]">
        <button
          type="button"
          className="rounded-xl text-lg leading-[1] border border-white/20 px-5 py-5 w-full bg-surface text-foreground text-left line-clamp-1 truncate"
