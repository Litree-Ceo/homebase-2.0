...
export default function LegacyBookPage({
  ...
  return (
    <main className="container relative w-full bg-background min-h-screen">
      <BackButton className="text-white bg-white/10 border-white/20 backdrop-blur-xl" />
      <HomeButton className="text-white bg-white/10 border-white/20 backdrop-blur-xl" />
      ...
      {destination && (
        <>
          <header className="relative h-72 w-full">
            ...
            <div className="flex flex-col gap-2 p-5 text-foreground absolute bottom-0 z-10">
          ...
          <section className="relative flex flex-col gap-3.5 px-5 py-7 w-full">
            <p className="text-foreground opacity-60 leading-[1.4] text-sm">
          ...
          <section className="px-5 flex flex-col gap-5 pb-32">
            <h2 className="text-foreground text-lg">Your Chosen Activities</h2>
