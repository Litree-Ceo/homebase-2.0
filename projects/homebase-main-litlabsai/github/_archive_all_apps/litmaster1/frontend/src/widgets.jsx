...
function ProfileWidget() {
  return (
    <div className="flex flex-col items-center">
      <img src="https://ui-avatars.com/api/?name=My+Space&background=random&size=120" alt="Avatar" className="rounded-full border-4 border-pink-400 mb-2" />
...
function MediaWidget() {
  return (
    <div>
      <video controls className="w-full rounded-lg" crossOrigin="anonymous">
        <source src="https://www.w3schools.com/html/mov_bbb.mp4" type="video/mp4" />
        Your browser does not support the video tag.
      </video>
      <div className="text-xs mt-2 text-blue-200">LitreMedia-style media player (demo)</div>
    </div>
  );
}
