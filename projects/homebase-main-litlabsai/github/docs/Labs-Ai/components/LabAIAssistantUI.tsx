      ...
      <div className="mt-4 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]">
        <div className="rounded-xl border border-white/10 bg-black/50 p-4">
          ...
          <p className="mt-2 text-sm text-slate-300">
            Pulsating neon orb with waveform, quick action chips, and premium
        ...
        <div className="rounded-xl border border-white/10 bg-white/5 p-4 text-sm text-slate-200">
          ...
          <ul className="mt-2 space-y-1.5">
            ...
            <li>
              Premium: voice personalization, advanced commands, payments via
              voice.
            </li>
            <li>
              Admin link: hidden commands for bans, session control, fraud
              alerts.
            </li>
          </ul>
          <div className="mt-3 rounded-lg border border-emerald-400/30 bg-emerald-500/10 px-3 py-2 text-emerald-100">
            Landing teaser: floating orb with “Ask me anything” and autoplay
            animation.
          </div>
        </div>
      </div>
