        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-slate-300">
                Your personal branded workspace & portfolio
              </p>
            </div>
            <a
              href={stationUrl}
          ...
          <div className="rounded-xl border border-slate-800 bg-slate-900/60 p-6">
            ...
            <p className="text-sm text-slate-400 mt-2">
              Share this link to showcase your work, collect followers, and earn
              referrals
            </p>
          </div>
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex-1">
                <p className="text-slate-300 mb-3">
                  Print this QR code on business cards, flyers, or merch. Anyone
                  who scans it lands on your station and you get credit for
                  referrals.
                </p>
                <button
                  onClick={() => {
