        ...
        <section className="grid gap-4 lg:grid-cols-2 text-xs sm:text-sm">
          ...
          <div className="rounded-3xl border border-white/15 bg-black/80 p-4 sm:p-5 backdrop-blur space-y-3">
            ...
            <p className="text-[11px] text-white/60">
              Later, you can wire this to Firestore usage data. For now, this is
              a visual placeholder showing posts + DMs + promos across the week.
            </p>
        ...
        <section className="grid gap-4 lg:grid-cols-2 text-xs sm:text-sm">
          <div className="rounded-3xl border border-white/15 bg-black/80 p-4 sm:p-5 backdrop-blur space-y-3">
            ...
            <ul className="space-y-2 text-[11px] text-white/75">
              ...
              <li>
                • You&apos;re using{" "}
                <span className="font-mono">/fraud_check</span> a healthy amount
                — better safe than sorry with weird offers.
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-2 text-[11px] text-white/85">
              <li>
                ...
                <span className="font-semibold">
                  1 LitLabs-powered post per day
                </span>
                .
              </li>
              <li>
