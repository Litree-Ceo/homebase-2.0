      ...
      <div className="space-y-8">
        ...
        <div className="bg-gradient-to-r from-emerald-950/40 via-slate-900/40 to-slate-950/40 border border-emerald-700/40 rounded-3xl p-8">
          ...
          <ul className="space-y-2 text-sm text-slate-300">
            ...
            <li>
              ✓{" "}
              <span className="font-semibold">Update slow days regularly</span>{" "}
              so we know when to suggest promos and fill rates
            </li>
            <li>
              ✓ <span className="font-semibold">List your ideal clients</span>{" "}
              so we can tailor DM scripts and offers to your dream customer
            </li>
            <li>
              ✓{" "}
