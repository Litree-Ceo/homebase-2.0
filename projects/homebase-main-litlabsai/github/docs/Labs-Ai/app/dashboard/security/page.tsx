      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div>
          <h1 className="text-4xl font-black mb-2">
            🔐 Security & Snoop Detection
          </h1>
          <p className="text-gray-400">
            LitLabs monitors your account for suspicious activity, new devices,
            brute-force attempts, location changes, and unauthorized access.
          </p>
        </div>
