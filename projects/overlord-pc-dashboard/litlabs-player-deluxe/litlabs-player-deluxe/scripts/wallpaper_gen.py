...
def generate_litlab_neon(name="neon_litlab.png") -> str:
    ...
    img = add_neon_text(
        img, "LITLAB v1.0", (200, 380), 110, (0, 255, 157), (255, 0, 255)
    )
    img = add_neon_text(
...
def generate_blood_samurai(name="blood_samurai.png") -> str:
    ...
    img = add_neon_text(
        img, "戦士 // LITLAB", (430, 560), 70, (255, 80, 0), (180, 0, 0)
    )
...
def generate_wallpaper(theme: str = "glitch") -> str:
    """
    Called by litlabs_bridge.py.  Returns the saved file path.
    ...
    dispatch = {
        ...
        "neon": lambda: generate_litlab_neon(f"neon_{uid}.png"),
        "blood": lambda: generate_blood_samurai(f"blood_{uid}.png"),
    }
    fn = dispatch.get(theme, lambda: generate_litlab_neon(f"glitch_{uid}.png"))
    return fn()
